...
from datasets.threedfront import threedfrontDataset
...
def get_datasets(config):
    ...
    elif(config.dataset=='threedfront'):
        train_set = threedfrontDataset(config,test=False,data_augmentation=True)
        val_set = threedfrontDataset(config,test=True,data_augmentation=False)
        benchmark_set = threedfrontDataset(config, test=True,data_augmentation=False)
    else:
